...
4) Скопировать на сервер файл docker-compose.yml
...
6) В строке, отмеченной #пароль к PKCS #12, ввести заменить <password> на ваш пароль к файлу PKCS#12 (s.pfx)

7) В каталоге с файлом docker-compose.yml выполнить `docker compose pull`
