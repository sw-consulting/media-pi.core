...
namespace MediaPi.Core.Migrations
{
    ...
    [Migration("20260625085138_0_10_2_Unique_VideoDescription")]
    partial class _0_10_2_Unique_VideoDescription
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MediaPi.Core.Models.Video", b =>
                {
                    ...
                    b.HasIndex("AccountId", "OriginalFilename")
                        .IsUnique()
                    ...
                    b.HasIndex("CategoryId", "OriginalFilename")
                        .IsUnique()
