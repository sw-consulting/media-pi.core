...
public class VideoViewItemTests
{
    ...
    public void Constructor_WithMaxValues_HandlesCorrectly()
    {
        ...
        Assert.That(viewItem.FileSize, Contains.Substring("√б")); // uint.MaxValue is ~4GB, not TB
    ...
    [TestCase(1024u, "1  б")]
    [TestCase(1536u, "2  б")]  // 1.5KB rounds to 2KB
    [TestCase(2048u, "2  б")]
    [TestCase(10240u, "10  б")]
    [TestCase(1048575u, "1024  б")] // Just under 1MB
    ...
    [TestCase(1048576u, "1.00 ћб")]      // 1 MB
    [TestCase(1572864u, "1.50 ћб")]     // 1.5 MB
    [TestCase(2097152u, "2.00 ћб")]     // 2 MB
    [TestCase(10485760u, "10.00 ћб")]   // 10 MB
    [TestCase(104857600u, "100.00 ћб")] // 100 MB
    [TestCase(1073741823u, "1024.00 ћб")] // Just under 1GB
    ...
    [TestCase(1073741824u, "1.00 √б")]   // 1 GB
    [TestCase(1610612736u, "1.50 √б")]  // 1.5 GB
    [TestCase(2147483648u, "2.00 √б")]  // 2 GB
    [TestCase(3221225472u, "3.00 √б")]  // 3 GB
    [TestCase(4294967295u, "4.00 √б")]  // uint.MaxValue (just under 4GB)
    ...
    public void ToString_ContainsAllProperties()
    {
        ...
        Assert.That(jsonString, Does.Contain("1.00 ћб"));
    ...
    public void ToString_HandlesSpecialCharacters()
    {
        // Arrange
        var video = CreateTestVideo(
            title: "“естовое видео с русскими символами \"и кавычками\"",
        ...
        // Assert
        Assert.DoesNotThrow(() => JsonSerializer.Deserialize<object>(jsonString));
        Assert.That(jsonString, Does.Contain("“естовое видео"));
    }
